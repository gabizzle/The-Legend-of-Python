...
playlist = [
  '1. Future/Metro Booming feat. Kendrick Lamar - Like That',
  '2. Drake feat. J Cole - First Person Shooter',
  '3. Kendrick Lamar - Mr. Morale',
  '4. Travis Scott - My Eyes',
  "5. A$AP Rocky - Fashion Killa",
  '6. Kanye feat. Pusha T - Runaway'
]
